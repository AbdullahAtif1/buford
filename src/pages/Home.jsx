...
const Home = () => {
  ...
  const PHONE = "(702) 587-5999";
  const EMAIL = "jbufordnetflix@gmail.com";
  const MC_NUMBER = "1810484";
  const DOT_NUMBER = "4556615";
  const HOME_BASE = "10036 SABLE POINT ST LAS VEGAS, NV 89178";
  ...
  const handleDownload = (docName) => {
    ...
    fetch(filePath)
      ...
      .then(blob => {
        ...
        link.href = url;
        link.setAttribute('download', `${docName.replace(/\s+/g, '_')}_JB.jpg`);
  ...
  const handleUnlock = (e) => {
    e.preventDefault();
    if (accessCode.toUpperCase() === 'JB2026') {
      setIsUnlocked(true); 
      setShowModal(false); 
      setError('');
    } else { 
      setError('Invalid Code. Try "JB2026"'); 
    }
  };
  ...
  const handleQuoteRequest = (e) => {
    ...
    const subject = encodeURIComponent(`Quote Request: ${quoteOrigin} to ${quoteDest} - JB HAULING LLC`);
    const body = encodeURIComponent(
      `Hi Andre,\n\nI am reaching out to request a quote for a load moving from ${quoteOrigin} to ${quoteDest}.\n\nEquipment Required: 26ft Box Truck\nCarrier: JB HAULING LLC (MC# ${MC_NUMBER})\n\nPlease let me know your availability and rate for this lane.\n\nBest regards,`
    );
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up z-20">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-none tracking-tight text-gray-900">
              <span className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-red-400">JB HAULING LLC</span><br />
            </h1>
            
            <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
              <strong>SOUTHWEST ↔ WEST COAST Specialist.</strong> <br/>
          ...
          <div className="relative w-full h-full animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            <div className="clip-trap relative z-10 bg-gray-800 aspect-[4/5] shadow-2xl group overflow-hidden">
              <img 
                src={heroTruck} 
                alt="JB HAULING LLC 26ft International Box Truck" 
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
           {/* Image Side */}
            <div className="relative group hover-lift">
              ...
              <img 
                src={driverImg} 
                alt="JAMES BUFORD - Owner Operator" 
              ...
              <div className="absolute bottom-6 left-6 bg-black/80 backdrop-blur-md px-6 py-4 border-l-4 border-red-600 shadow-lg">
                <p className="font-black text-xl uppercase text-white">JAMES BUFORD</p>
          ...
          <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed border-l-4 border-red-200 pl-4">
                "I operate under my own authority to kill the anxiety brokers feel when they hang up the phone. When you book JB HAULING LLC, you aren't talking to a dispatcher—you're talking to the driver. 
                <br/><br/>
      ...
      <section id="lanes" className="py-20 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['NEVADA', 'CALIFORNIA', 'ARIZONA', 'UTAH', 'IDAHO', 'OREGON', 'WASHINGTON'].map((state, index) => (
                <span 
                  key={state} 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
              ...
              <div className="bg-white p-1 clip-trap">
                <form className="grid grid-cols-1 sm:grid-cols-2 gap-2 p-2 bg-white">
                  ...
                  >
                    <option value="">Origin (Southwest)</option>
                    <option>NV - Nevada (HQ)</option>
                  ...
                  <select
                    ...
                    className="bg-gray-100 p-4 font-bold text-gray-700 outline-none focus:bg-gray-200 transition-colors cursor-pointer"
                  >
                    <option value="">Destination (West Coast)</option>
